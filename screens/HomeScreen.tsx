...
import Pressable from "@/src/components/Restyle/Pressable";
...
import BottomSheetDropdown from "@/src/components/Dropdown";
        ...
        <Box px="sm" pb="md">
            ...
            >
              ...
              >
                ...
                <Box flex={1}>
                  ...
                  <Text variant="medium12" color="textTint">
                    General Specialist
                  </Text>
                </Box>
                <Pressable p="sm">
          ...
          <Box marginBottom="lg">
            ...
            >
              ...
              <Pressable>
                <Text variant="medium14" color="black" fontWeight="500">
                  See All
                </Text>
              </Pressable>
            </Box>
            ...
            >
              {specialties.map((specialty, index) => (
                ...
                >
                  ...
                  <Text variant="medium12" color="black" textAlign="center">
                    {specialty.name}
                  </Text>
                </Pressable>
              ))}
